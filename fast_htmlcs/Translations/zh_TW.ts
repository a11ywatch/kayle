_global.translation["zh-TW"] = {
  auditor_success_criterion: "成功標準",
  auditor_suggested_techniques: "建議技巧",
  "1_1_1_H30.2":
    "Img 元素是鏈接的唯一內容，但是缺少了 alt 文本，alt 文本應該描述鏈接的用途",
  "1_1_1_H67.1": "alt 文本為空的 Img 元素必須具有缺席或空 title 屬性",
  "1_1_1_H67.2": "標記 Img 元素，使其被輔助技術忽略。",
  "1_1_1_H37": "缺少 alt 屬性的 Img 元素。使用 alt 屬性指定一個短的替代文本",
  "1_1_1_G94.Image":
    "確保 img 元素的 alt 文本具有與圖像相同的用途和顯示相同的信息。",
  "1_1_1_H36":
    "圖像提交按鈕缺少 alt 屬性。使用 alt 屬性指定描述按鈕功能的文本替代方案。",
  "1_1_1_G94.Button": "確保圖像提交按鈕的 alt 文本識別按鈕的用途。",
  "1_1_1_H24":
    "圖像映射中缺少 alt 屬性的 Area 元素。每個 area 元素必須有一個描述圖像映射區域功能的文本選項。",
  "1_1_1_H24.2":
    "確保 area 元素的文本替代與它引用的圖像映射圖像部分的用途相同。",
  "1_1_1_G73,G74":
    "如果無法在短文本替代中完整描述此圖像，請確保也提供長文本替代，例如在正文文本中或通過鏈接。",
  "1_1_1_H2.EG5": "鏈接內的 Img 元素不能使用與鏈接的文本內容重複的 alt 文本。",
  "1_1_1_H2.EG4":
    "當鏈接旁邊的鏈接包含鏈接文本時，鏈接內的 Img 元素的 alt 文本為空或缺失。考慮合併這些鏈接。",
  "1_1_1_H2.EG3":
    "鏈接內的 Img 元素不能使用與旁邊的文本鏈接內容重複的 alt 文本。",
  "1_1_1_H53,ARIA6": "對象元素必須在耗盡所有其他替代後包含文本替代。",
  "1_1_1_G94,G92.Object,ARIA6":
    "檢查是否可以為具有相同目的和顯示相同信息的非文本內容提供短文本（如果適合，也可以是長文本）替代方案。",
  "1_1_1_H35.3":
    "對於不支持 Applet 元素的瀏覽器，Applet 元素必須在元素的主體中包含一個文本替代。",
  "1_1_1_H35.2":
    "Applet 元素必須包含 alt 屬性，以便為支持該元素但無法載入 Applet 的瀏覽器提供文本替代。",
  "1_1_1_G94,G92.Applet":
    "檢查是否可以為具有相同目的和顯示相同信息的非文本內容提供短文本（如果適合，也可以是長文本）替代方案。",
  "1_2_1_G158":
    "如果此嵌入式對象僅包含預錄的音頻，且不作為文本內容的替代提供，請檢查是否提供了替代文本版本。",
  "1_2_1_G159,G166":
    "如果此嵌入式對象僅包含預錄的視頻，且不作為文本內容的替代提供，則請檢查是否提供了替代文本版本，或提供了表示等效信息的音軌。",
  "1_2_2_G87,G93":
    "如果此嵌入式對象包含預錄的同步媒體，且未作為文本內容的替代提供，請檢查是否為音頻內容提供了標題。",
  "1_2_3_G69,G78,G173,G8":
    "如果這個嵌入的對象包含預先錄制的同步媒體，並且沒有作為文本內容的替代提供，請檢查是否提供了視頻的音頻描述和/或內容的替代文本版本。",
  "1_2_4_G9,G87,G93":
    "如果此嵌入式對象包含同步媒體，請檢查是否為實時音頻內容提供標題。",
  "1_2_5_G78,G173,G8":
    "如果此嵌入式對象包含預錄的同步媒體，請檢查是否為其視頻內容提供了音頻描述。",
  "1_2_6_G54,G81":
    "如果此嵌入式對象包含預錄的同步媒體，請檢查是否為其音頻提供了手語解釋。",
  "1_2_7_G8":
    "如果這個嵌入的對象包含同步媒體，並且前臺音頻中的暫停不足以讓音頻描述傳遞預錄制視頻的感覺，那麼請檢查是否提供了擴展的音頻描述，無論是通過腳本還是其他版本。",
  "1_2_8_G69,G159":
    "如果這個嵌入的對象包含預定位的同步媒體或視頻內容，請檢查是否提供了內容的另一個文本版本。",
  "1_2_9_G150,G151,G157":
    "如果這個嵌入的對象包含實時音頻內容，請檢查是否提供了內容的另一個文本版本。",
  "1_3_1_F92,ARIA4": "此元素的角色是“表示”，但包含具有語義意義的子元素。",
  "1_3_1_H44.NonExistent": "此標籤的“for”屬性包含文檔中不存在的ID。",
  "1_3_1_H44.NonExistentFragment":
    "此標籤的“for”屬性包含文檔片段中不存在的ID。",
  "1_3_1_H44.NotFormControl":
    '這個label的 "for"屬性包含一個非表單控制元素的ID。確保您為預期的元素輸入了正確的ID。',
  "1_3_1_H65":
    "此表單控制項的“title”屬性為空或僅包含空格。為了標籤測試的目的，它將被忽略。",
  "1_3_1_ARIA6":
    "此表單控制項具有“aria-label”屬性，該屬性為空或僅包含空格。為了標籤測試的目的，它將被忽略。",
  // n
  ...
  "1_4_3_G18_or_G145.BgGradient":
    "该元素的文本放置在背景渐变之上。确保文本和渐变的所有重叠部分之间的对比度至少为 {{required}}:1。",
