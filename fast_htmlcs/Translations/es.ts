_global.translation["es"] = {
  auditor_success_criterion: "Criterio de Éxito",
  auditor_suggested_techniques: "Técnicas Sugeridas",
  "1_1_1_H30.2":
  ...
  "1_3_1_H44.NonExistent":
    'El atributo "for" de esta etiqueta contiene una ID que no existe en el documento.',
  "1_3_1_H44.NonExistentFragment":
    'El atributo "for" de esta etiqueta contiene una ID que no existe en el fragmento de documento.',
  ...
  "1_3_1_ARIA16,ARIA9":
    'Este control de formulario contiene un atributo aria-labelledby, sin embargo, incluye una ID "{{id}}" que no existe en un elemento. Se ignorará el atributo aria-labelledby para fines de prueba de etiquetas.',
  "1_3_1_F68.Hidden":
  ...
  "1_3_1_H49.": "Marcado presentacional obsoleto utilizado en HTML5.",
  "1_3_1_H49.AlignAttr": "Atributos de alineación.",
  "1_3_1_H49.Semantic":
  ...
  "1_3_1_H43.IncorrectAttr":
    'Atributo headers incorrecto en este elemento td. Se esperaba "{{expected}}", pero se encontró "{{actual}}".',
  ...
  "1_3_1_G141_b":
    "La estructura de encabezados no está anidada de forma lógica. Este elemento h{{headingNum}} debería ser un elemento h{{properHeadingNum}} para estar anidado correctamente.",
  "1_3_1_H42.2":
  ...
  "1_4_3_G18_or_G145.Fail":
    "Este elemento tiene un contraste insuficiente en este nivel de conformidad. Se espera una relación de contraste de al menos {{required}}:1, pero el texto en este elemento tiene una relación de contraste de {{value}}:1.",
  "1_4_3_G18_or_G145.Fail.Recomendation": "Recomendación: ",
  ...
  "1_4_3_G18_or_G145.Fail.Recomendation.Background":
    "cambiar el color de fondo a {{value}}",
  ...
  "1_4_10_C32,C31,C33,C38,SCR34,G206.Check":
    "Verifica que el contenido se pueda presentar sin pérdida de información o funcionalidad, y sin requerir desplazamiento en dos dimensiones para: \
  Contenido de desplazamiento vertical en un ancho equivalente a 320 píxeles CSS; \
  Contenido de desplazamiento horizontal en una altura equivalente a 256 píxeles CSS; \
  Excepto para las partes del contenido que requieren diseño en dos dimensiones para su uso o significado.",
  ...
  "1_4_11_G195,G207,G18,G145,G174,F78.Check":
    "Verifica que la presentación visual de lo siguiente tenga una relación de contraste de al menos 3:1 frente al color (o colores) adyacentes: \
  Componentes de la Interfaz de Usuario: información visual requerida para identificar componentes y estados de la interfaz de usuario, excepto en componentes inactivos o donde la apariencia del componente es determinada por el agente de usuario y no modificada por el autor; \
  Objetos Gráficos: partes de gráficos necesarias para entender el contenido, excepto cuando una presentación particular de los gráficos es esencial para la información transmitida.",
  "1_4_12_C36,C35.Check":
    "Verificar que no se produce ninguna pérdida de contenido o funcionalidad estableciendo todo lo siguiente y sin cambiar ninguna otra propiedad de estilo: \
  Espaciado entre líneas (interlineado) al menos 1,5 veces el tamaño de fuente; \
  Espaciado entre párrafos siguientes de al menos 2 veces el tamaño de fuente; \
  Espaciado entre letras (tracking) de al menos 0,12 veces el tamaño de fuente; \
  Espaciado entre palabras de al menos 0,16 veces el tamaño de fuente.",
  "1_4_13_F95.Check":
    "Verifica que donde al recibir y luego eliminar el puntero de desplazamiento o el enfoque del teclado se activa contenido adicional para que se vuelva visible y luego oculto, se cumpla lo siguiente: \
  Descartable: hay un mecanismo disponible para descartar el contenido adicional sin mover el puntero de desplazamiento o el enfoque del teclado, a menos que el contenido adicional comunique un error de entrada o no oscurezca ni reemplace otro contenido; \
  Se puede desplazar el cursor: si el puntero de desplazamiento puede activar el contenido adicional, entonces el puntero se puede mover sobre el contenido adicional sin que el contenido adicional desaparezca; \
  Persistente: el contenido adicional permanece visible hasta que se elimina el activador de enfoque o desplazamiento, el usuario lo descarta, o su información ya no es válida.",
  "2_1_1_G90":
  ...
  "2_1_4.Check":
    "Verifica que, si se implementa un atajo de teclado en el contenido utilizando solamente letras (incluidas letras mayúsculas y minúsculas), puntuación, números, o caracteres de símbolo, entonces al menos una de las siguientes opciones es verdadera: \
    Desactivar: un mecanismo está disponible para desactivar el atajo; \
    Remapear: un mecanismo está disponible para remapear el atajo para usar uno o más caracteres del teclado no imprimibles (por ejemplo, Ctrl, Alt, etc.); \
    Activo sólo con enfoque: el atajo del teclado para un componente de la interfaz de usuario solo está activo cuando ese componente tiene el enfoque.",
  "2_2_1_F40.2":
  ...
  "2_4_2_H25.1.EmptyTitle":
    "El elemento de título en la sección head debe ser no vacío.",
  "2_4_2_H25.2": "Verifica que el elemento de título describe el documento.",
  "2_4_3_H4.2":
  ...
  "2_5_2.SinglePointer_Check":
    "Verifica que para la funcionalidad que puede ser operada utilizando un solo puntero, al menos una de las siguientes opciones es verdadera: \
    Sin evento de pulsación: El evento de pulsación del puntero no se utiliza para ejecutar ninguna parte de la función; \
    Abortar o deshacer: La finalización de la función es en el evento de soltar, y hay un mecanismo disponible para abortar la función antes de la finalización o para deshacer la función después de la finalización; \
    Reversión de soltar: El evento de soltar revierte cualquier resultado del evento de pulsación anterior; \
    Esencial: Completar la función en el evento de pulsación es esencial.",

  "2_5_2.Mousedown_Check":
    "Este elemento tiene un escucha de evento mousedown. Verifica que, para la funcionalidad que puede ser operada utilizando un solo puntero, al menos una de las siguientes opciones es verdadera: \
    Sin evento de pulsación: El evento de pulsación del puntero no se utiliza para ejecutar ninguna parte de la función; \
    Abortar o deshacer: La finalización de la función es en el evento de soltar, y hay un mecanismo disponible para abortar la función antes de la finalización o para deshacer la función después de la finalización; \
    Reversión de soltar: El evento de soltar revierte cualquier resultado del evento de pulsación anterior; \
    Esencial: Completar la función en el evento de pulsación es esencial.",
  ...
  "2_5_2.Touchstart_Check":
    "Este elemento tiene un escucha de evento touchstart. Verifica que, para la funcionalidad que puede ser operada utilizando un solo puntero, al menos una de las siguientes opciones es verdadera: \
    Sin evento de pulsación: El evento de pulsación del puntero no se utiliza para ejecutar ninguna parte de la función; \
    Abortar o deshacer: La finalización de la función es en el evento de soltar, y hay un mecanismo disponible para abortar la función antes de la finalización o para deshacer la función después de la finalización; \
    Reversión de soltar: El evento de soltar revierte cualquier resultado del evento de pulsación anterior; \
    Esencial: Completar la función en el evento de pulsación es esencial.",
  ...
  "2_5_4.Check":
    "Verifica que la funcionalidad que puede ser operada por el movimiento del dispositivo o del usuario también pueda ser operada por componentes de la interfaz de usuario, y que se pueda desactivar la respuesta al movimiento para prevenir activación accidental, excepto cuando: \
    Interfaz soportada: El movimiento se utiliza para operar la funcionalidad a través de una interfaz de accesibilidad soportada; \
    Esencial: El movimiento es esencial para la función y hacerlo invalidaría la actividad.",

  "2_5_4.Devicemotion":
    "Este elemento tiene un escucha de evento devicemotion. Verifica que la funcionalidad que puede ser operada por el movimiento del dispositivo o del usuario también pueda ser operada por componentes de la interfaz de usuario, y que se pueda desactivar la respuesta al movimiento para prevenir activación accidental, excepto cuando: \
    Interfaz soportada: El movimiento se utiliza para operar la funcionalidad a través de una interfaz de accesibilidad soportada; \
    Esencial: El movimiento es esencial para la función y hacerlo invalidaría la actividad.",

  "2_5_5.Check":
    "Verifica que el tamaño del objetivo para las entradas de puntero sea al menos 44 por 44 píxeles CSS, excepto cuando: \
    Equivalente: El objetivo está disponible a través de un enlace o control equivalente en la misma página que es al menos 44 por 44 píxeles CSS; \
    En línea: El objetivo está en una oración o bloque de texto; \
    Control de agente de usuario: El tamaño del objetivo está determinado por el agente de usuario y no es modificado por el autor; \
    Esencial: Una presentación particular del objetivo es esencial para la información que se está transmitiendo.",
  "2_5_6.Check":
  ...
  "4_1_2_msg_pattern":
    "Este {{msgNodeType}} no tiene un nombre disponible para una API de accesibilidad. Los nombres válidos son: {{builtAttrs}}.",
  "4_1_2_msg_pattern_role_of_button":
    'Este elemento tiene un rol de "button" pero no tiene un nombre disponible para una API de accesibilidad. Los nombres válidos son: {{builtAttrs}}.',

  "4_1_2_msg_pattern2":
    "Este {{msgNodeType}} no tiene un valor disponible para una API de accesibilidad.",
  "4_1_2_msg_add_one": "Agrega uno agregando contenido al elemento.",
  "4_1_2_msg_pattern3":
    "Este {{msgNodeType}} no tiene una opción inicialmente seleccionada. Dependiendo de la versión de HTML, el valor expuesto a una API de accesibilidad puede ser indefinido.",
  "4_1_2_value_exposed_using_attribute":
    "Se expone un valor usando el atributo {{requiredValue}}.",
  "4_1_2_value_exposed_using_element":
    "Se expone un valor usando el elemento {{requiredValue}}.",
