_global.translation["ko"] = {
  auditor_success_criterion: "성공 기준",
  auditor_suggested_techniques: "제안된 기술",
  "1_1_1_H30.2":
    "Img 요소가 링크의 유일한 내용이지만 alt 텍스트가 누락되었습니다. alt 텍스트는 링크의 목적을 설명해야 합니다.",
  "1_1_1_H67.1":
    "빈 alt 텍스트를 가진 Img 요소는 없거나 빈 title 속성을 가져야 합니다.",
  "1_1_1_H67.2": "Img 요소가 보조 기술에 의해 무시되도록 표시됩니다.",
  "1_1_1_H37":
  ...
  "1_3_1_H44.NonExistent":
    "이 레이블의 'for' 속성에는 문서에 존재하지 않는 ID가 포함되어 있습니다.",
  "1_3_1_H44.NonExistentFragment":
    "이 레이블의 'for' 속성에는 문서 조각에 존재하지 않는 ID가 포함되어 있습니다.",
  ...
  "1_3_1_H43.IncorrectAttrNotice": "td 요소의 헤더 속성이 올바른지 확인하세요.",
  ...
  "1_3_1_G141_b":
    "제목 구조가 논리적으로 중첩되지 않았습니다. 이 h{{headingNum}} 요소는 제대로 중첩되기 위해 h{{properHeadingNum}}이어야 합니다.",
  "1_3_1_H42.2":
  ...
  "2_4_2_H25.1.NoHeadEl":
    "설명적인 제목 요소를 배치할 수 있는 헤드 섹션이 없습니다.",
  "2_4_2_H25.1.NoTitleEl":
    "헤드 섹션에 비어 있지 않은 제목 요소를 사용하여 문서에 제목을 제공해야 합니다.",
  "2_4_2_H25.1.EmptyTitle": "헤드 섹션의 제목 요소는 비어 있지 않아야 합니다.",
  "2_4_2_H25.2": "제목 요소가 문서를 설명하는지 확인합니다.",
  "2_4_3_H4.2":
  ...
  "1_4_3_G18_or_G145.Fail":
    "이 요소는 이 준수 수준에서 불충분한 대비를 가지고 있습니다. 텍스트의 대비 비율이 최소 {{required}}:1이어야 하지만, 이 요소에는 {{value}}:1의 대비 비율이 있습니다.",
  "1_4_3_G18_or_G145.Fail.Recomendation": "추천: ",
  "1_4_3_G18_or_G145.Fail.Recomendation.Text":
    "텍스트 색상을 {{value}}(으)로 변경하세요",
  ...
  "1_4_6_G18_or_G17.BgGradient":
    "이 요소의 텍스트는 배경 그라데이션 위에 배치됩니다. 텍스트와 모든 덮인 그라데이션 부분 사이의 대비 비율이 최소 {{required}}:1 이상인지 확인하십시오.",
  "1_4_6_G18_or_G17.Fail":
    "이 요소는 이 준수 수준에서 불충분한 대비를 가지고 있습니다. 텍스트의 대비 비율이 최소 {{required}}:1이어야 하지만, 이 요소에는 {{value}}:1의 대비 비율이 있습니다.",
  "1_4_6_G18_or_G17.Fail.Recomendation": "추천: ",
  ...
  "1_4_10_C32,C31,C33,C38,SCR34,G206.Check":
    "다음 경우에 정보나 기능이 손실되지 않고, 두 방향으로 스크롤할 필요 없이 콘텐츠를 제시할 수 있는지 확인합니다: \
      세로 스크롤 콘텐츠의 경우 320 CSS 픽셀에 해당하는 너비; \
      가로 스크롤 콘텐츠의 경우 256 CSS 픽셀에 해당하는 높이; \
      사용 또는 의미에 대한 이차원 레이아웃이 필요한 콘텐츠 부분을 제외하고.",
  "2_5_3_F96.Check":
  ...
  "4_1_2_input_element": "input 요소",
  "4_1_2_element_content": "요소 내용",
  "4_1_2_element": "요소",
  "4_1_2_msg_pattern":
    "이 {{msgNodeType}}는 접근성 API에 이름이 제공되지 않습니다. 유효한 이름은 다음과 같습니다: {{builtAttrs}}.",
  "4_1_2_msg_pattern_role_of_button":
    "이 요소는 '버튼' 역할을 가지고 있지만 접근성 API에 이름이 제공되지 않습니다. 유효한 이름은 다음과 같습니다: {{builtAttrs}}.",
  "4_1_2_msg_pattern2":
    "이 {{msgNodeType}}는 접근성 API에 값이 제공되지 않습니다.",
  "4_1_2_msg_add_one": "요소에 내용을 추가함으로써 하나를 추가하세요.",
  "4_1_2_msg_pattern3":
    "이 {{msgNodeType}}는 초기에 선택된 옵션이 없습니다. HTML 버전에 따라 접근성 API에 노출되는 값이 정의되지 않을 수 있습니다.",
  "4_1_2_value_exposed_using_attribute":
    "{{requiredValue}} 속성을 사용하여 값이 노출됩니다.",
  "4_1_2_value_exposed_using_element":
    "{{requiredValue}} 요소를 사용하여 값이 노출됩니다.",
