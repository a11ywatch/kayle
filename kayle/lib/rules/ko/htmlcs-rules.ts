...
export const htmlcsRules = [
  ...
  },
  {
    ...
    description:
      "제목 구조가 논리적으로 중첩되지 않았습니다. 이 h{{headingNum}} 요소는 주 문서 제목으로 보이므로 h1 요소여야 합니다.",
    helpUrl: [],
    ruleType: "error",
    tags: ["WCAGA", "WCAGAA", "WCAGAAA"],
  },
  ...
  },
  {
    ...
    description:
      "이 요소의 자동완성 속성에 잘못될 수 있는 값이 포함되어 있습니다: {{valuesStr}}.",
    helpUrl: [],
    ruleType: "warning",
    tags: ["WCAGAA", "WCAGAAA"],
  },
  {
    ...
    description:
      "유효하지 않은 자동완성 값: {{x}}. 요소가 날짜 제어 그룹에 속하지 않습니다.",
    helpUrl: [],
    ruleType: "error",
    tags: ["WCAGAA", "WCAGAAA"],
  },
  {
    ...
    description:
      "유효하지 않은 자동완성 값: {{x}}. 요소가 월 제어 그룹에 속하지 않습니다.",
    helpUrl: [],
    ruleType: "error",
    tags: ["WCAGAA", "WCAGAAA"],
  },
  {
    ...
    description:
      "유효하지 않은 자동완성 값: {{x}}. 요소가 다줄 제어 그룹에 속하지 않습니다.",
    helpUrl: [],
    ruleType: "error",
    tags: ["WCAGAA", "WCAGAAA"],
  },
  {
    ...
    description:
      "유효하지 않은 자동완성 값: {{x}}. 요소가 숫자 제어 그룹에 속하지 않습니다.",
    helpUrl: [],
    ruleType: "error",
    tags: ["WCAGAA", "WCAGAAA"],
  },
  {
    ...
    description:
      "유효하지 않은 자동완성 값: {{x}}. 요소가 비밀번호 제어 그룹에 속하지 않습니다.",
    helpUrl: [],
    ruleType: "error",
    tags: ["WCAGAA", "WCAGAAA"],
  },
  {
    ...
    description:
      "유효하지 않은 자동완성 값: {{x}}. 요소가 전화번호 제어 그룹에 속하지 않습니다.",
    helpUrl: [],
    ruleType: "error",
    tags: ["WCAGAA", "WCAGAAA"],
  },
  {
    ...
    description:
      "유효하지 않은 자동완성 값: {{x}}. 요소가 텍스트 제어 그룹에 속하지 않습니다.",
    helpUrl: [],
    ruleType: "error",
    tags: ["WCAGAA", "WCAGAAA"],
  },
  {
    ...
    description:
      "유효하지 않은 자동완성 값: {{x}}. 요소가 URL 제어 그룹에 속하지 않습니다.",
    helpUrl: [],
    ruleType: "error",
    tags: ["WCAGAA", "WCAGAAA"],
  },
